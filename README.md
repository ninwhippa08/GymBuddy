...
│
├── data/
│   └── exercises.json    The exercise library: 405 exercises + 6 PR roots.
│
...
**Nine movement pools do not meet the variety target.**
`docs/coverage-matrix.md` is generated by the test suite and prints a raw
shortfall of 99, almost all of it now in the sprint, jump and interval pools.
The 2026-09-05 expansion took the library 258 → 405 and closed twelve points
of it, but it could not close these: the library holds 10 sprint entries
