...
│
├── data/
│   └── exercises.json    The exercise library: 458 exercises + 6 PR roots.
│
...
**Several movement pools do not meet the variety target.**
`docs/coverage-matrix.md` is generated by the test suite and prints the raw
shortfall, almost all of it now in the sprint, jump and interval pools. Two
playlist expansions on 2026-09-05 took the library 258 → 458 and closed part
of it, but they could not close these: the library holds 10 sprint entries
