...
| `primary :: squat/hinge/push-h/push-v/pull-v :: max-strength` | 1 | 16 | 25% (hip) | 4 | 16 | 16 | 0 |
| `primary+secondary :: (any) :: max-strength` | 1 | 34 | 38% (hip) | 3 | 16 | 16 | 0 |
| `secondary+accessory :: (any) :: hypertrophy` | 1 | 70 | 54% (hip) | 2 | 16 | 16 | 0 |
...
| `primary+secondary :: (any) :: hypertrophy` | 1 | 31 | 45% (hip) | 3 | 16 | 16 | 0 |
| `accessory :: lunge/carry/rotate :: hypertrophy` | 1 | 17 | 24% (hip) | 5 | 16 | 16 | 0 |
| `accessory :: (any) :: isolation` | 1 | 35 | 60% (shoulder) | 2 | 16 | 16 | 0 |
...
Raw shortfall across all pools: **13** (pools overlap, so an
