...
| `WEEKS_TRIGGER` | 4 | `[corroborated]` | Rogerson et al., "You can't shoot another bullet until you've reloaded the gun": Coaches' perceptions, practices and experiences of deloading in strength and physique sports, published online December 2022, PMC9811819 — reports deloads "programmed every 4 to 6 weeks." Corroborated by Rogerson, Nolan, Androulakis Korakakis, Immonen, Wolf & Bell, "Deloading Practices in Strength and Physique Sports: A Cross-sectional Survey," *Sports Medicine – Open* 2024, PMC10948666 — reports deloading undertaken "every 5.6 ± 2.3 weeks," consistent with the first study's range. Note: the two studies share overlapping authorship and the same study population (competitive strength/physique athletes), so this is two agreeing publications rather than two fully independent research groups. Borrowed by analogy only: that literature governs when a *lifter* should deload, not when running should be boosted — this app reuses the interval length (4, the low end of the cited range, appropriate given irregular 1-3x/week attendance already providing some natural unloading), not the underlying claim, per the analogy-not-application distinction (design §7.2). |
